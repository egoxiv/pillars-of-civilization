...
// **** TEMPFIX - btn-group display set to none with .hide() before overlay is appended. btn-group is set to .show() after decisionCount reaches 2.
...
var overlay = function(index, player) {
  ...
  var $button1     = $('<a class="btn btn-danger btn-sm" id="button1"></a>');
  ...
  var $button2     = $('<a class="btn btn-danger btn-sm " id="button2"></a>');
